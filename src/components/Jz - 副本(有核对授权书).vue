		...
		<main>
			<div id="page1" v-show="page1" style="margin-bottom: 100px;display: block;text-align: left;">
				...
				<van-form ref='rule1' @submit="next1">
					...
					<van-field name="ab_ex145" label="求助属实类别" required
						...
						<template #input>
							<van-checkbox-group v-model="ab_ex145" direction="horizontal"  @change="sslbChange">
								...
								<van-checkbox :disabled="sslbDisabled1" class="marginstyle" name="特困供养" shape="square">特困供养</van-checkbox>
								<van-checkbox :disabled="sslbDisabled1" class="marginstyle" name="家庭边缘" shape="square">低收入家庭</van-checkbox>
								<van-checkbox :disabled="sslbDisabled1" class="marginstyle" name="支出型困难" shape="square">支出型困难家庭</van-checkbox>
								...
								<van-checkbox :disabled="sslbDisabled1" class="marginstyle" name="临时救助" shape="square">临时救助</van-checkbox>
					...
					<van-field v-if="typelx!='特困供养' && typelx!='临时救助'" name="ab_ex41" required label="低保类型"
						:rules="[{ required: true, message: '请选择低保类型' }]">
						<template #input>
					...
					<!-- 临时 -->
					<van-field v-if="typelx=='临时救助'" name="ab_ex122" label="困难类型" required
			...
			<div id="page3" v-show="page3" class="stepPage" style="margin-bottom: 100px;display: block;padding-top: 20px;">
				...
				<div style="font-size:12px;padding-left:20px;padding-right:20px;text-align: left;">
					...
					<van-form style="margin-top: 20px;">
						...
						<van-field v-model="pay.abp_ex10" name="abp_ex10" label="扣减刚性指出后人均年收入"
							placeholder="扣减刚性指出后人均年收入" :rules="[{ required: true, message: '请填写扣减刚性指出后人均年收入' }]" type="number">
						</van-field>
						<div style="border-bottom: 10px solid #f3f3f3;"> </div>
					</van-form>
				</div>
