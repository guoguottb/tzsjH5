		...
		<main>
			<div id="page1" v-show="page1" class="page1Class">
				...
				<van-form ref='rule1' @submit="next1">
					...
					<van-field v-model="form.ab_ex43" center name="ab_ex43" maxlength="22" type="digit" label="银行账号" placeholder="银行账号" required
			...
			<div id="page4" v-show="page4" class="page2Class">
				...
				<div class="page2ClassDiv">
					...
					<van-form style="margin-top: 20px;">
						...
						<van-field v-model="form.ab_ex60" name="ab_ex60" maxlength="30" label="有价证券" placeholder="有价证券"
							:rules="[{ required: true, message: '请填写有价证券' }]">
						</van-field>
						<van-field v-model="form.ab_ex61" name="ab_ex61" maxlength="30" label="债权" placeholder="债权"
							:rules="[{ required: true, message: '请填写债权' }]">
						</van-field>
						<van-field v-model="form.ab_ex37" name="ab_ex37" maxlength="30" label="其他金融产品" placeholder="其他金融产品"
